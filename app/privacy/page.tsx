...
export default function Privacy() {
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-10">
      ...
      <p className="mt-2 text-sm text-muted">Effective August 30, 2026</p>
      <div className="mt-6 space-y-4 text-[15px] leading-relaxed">
        <p>
          Eatimate is a static calculator: there are no accounts, no sign-ups,
          and nothing you build here is sent to us. Meal totals are computed in
          your browser, and a meal you share lives entirely in the link&apos;s
          address — we never receive or store it.
        </p>
        ...
        <p>
          ...
          . We may use privacy-preserving, cookieless aggregate analytics
          (page-view counts, not individual tracking).
        </p>
